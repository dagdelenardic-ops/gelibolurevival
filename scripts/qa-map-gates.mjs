import { hydrateTimelineData } from '../src/engine/phase-engine.js?v=20260523-markers-r2';
import { expandUnitTrails, getTerrainSafePointForUnit } from '../src/engine/position-engine.js?v=20260523-markers-r2';
import { BATTLE_DATA, getMapLocationById } from '../src/data/battle-data.js?v=20260523-markers-r2';
import { calibrationReport } from '../src/data/geo-calibration.js?v=20260523-markers-r2';
import { HISTORICAL_ANCHORS as STORY_ANCHORS } from '../src/data/historical-anchors.js?v=20260523-markers-r2';
import { CANONICAL_POSITIONS, OFF_MAP_LOCATIONS } from '../src/data/canonical-positions.js?v=20260523-markers-r2';
import {
    HISTORICAL_ANCHORS,
    HISTORICAL_ROUTES,
...
} from '../src/data/historical-map-data.js?v=20260523-markers-r2';
import { GUIDED_CAMPAIGN_CHAPTERS } from '../src/data/guided-campaign.js?v=20260523-markers-r2';
