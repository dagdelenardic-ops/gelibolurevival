...
import { normalizeValue } from '../engine/date-utils.js?v=20260622-hp-polish-r1';
import {
    unitSeed,
    getClusterOffset, getUnitEntryOrigin, getTerrainSafePointForUnit, getNavalDisplayOffset, isDestroyedPhaseData,
    isLockedPhaseData
} from '../engine/position-engine.js?v=20260622-hp-polish-r1';
import { getUnitEntryPhaseIndex } from '../engine/phase-engine.js?v=20260622-hp-polish-r1';
...
import { getUnitVisualProfile, getSpriteSetId, hasRuntimeSpriteAtlas } from '../data/unit-visual-profiles.js?v=20260622-hp-polish-r1';
