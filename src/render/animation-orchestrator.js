...
import { getActiveFrontNames } from './director.js?v=20260620-combat-fx-r1';
import { clampToAllowedTerrain } from '../data/terrain-zones.js?v=20260620-combat-fx-r1';
import { getUnitVitals } from '../data/casualty-model.js?v=20260620-combat-fx-r1';
...
import {
    ...
    renderClashMarker,
} from './animation-language.js?v=20260620-combat-fx-r1';
