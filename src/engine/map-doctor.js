...
import { MAP_WIDTH, MAP_HEIGHT, MAP_CROP_TOP } from '../data/coordinate-map.js?v=20260618-3d-spectacle-r2';
import { MAP_SCENE_LABELS, calibrationReport } from '../data/geo-calibration.js?v=20260618-3d-spectacle-r2';
import { getTerrainAtPoint, clampToAllowedTerrain, waitForTerrainSampler } from '../data/terrain-zones.js?v=20260618-3d-spectacle-r2';
import { isUnitOffMap, OFF_MAP_LOCATIONS } from '../data/canonical-positions.js?v=20260618-3d-spectacle-r2';
import {
    getHistoricalDataDiagnostics,
    getHistoricalPlacementForUnit,
    getHistoricalSourcesForIds
} from '../data/historical-map-data.js?v=20260618-3d-spectacle-r2';
import { getUnitEntryPhaseIndex } from './phase-engine.js?v=20260618-3d-spectacle-r2';
import {
...
} from './position-engine.js?v=20260618-3d-spectacle-r2';
import { resolveCampaignPhase } from './campaign-state-machine.js?v=20260618-3d-spectacle-r2';
