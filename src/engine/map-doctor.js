...
import { MAP_SCENE_LABELS, calibrationReport } from '../data/geo-calibration.js?v=20260622-hp-polish-r1';
import { getTerrainAtPoint, clampToAllowedTerrain, waitForTerrainSampler } from '../data/terrain-zones.js?v=20260622-hp-polish-r1';
import { isUnitOffMap, OFF_MAP_LOCATIONS } from '../data/canonical-positions.js?v=20260622-hp-polish-r1';
import {
    getHistoricalDataDiagnostics,
    getHistoricalPlacementForUnit,
    getHistoricalSourcesForIds
} from '../data/historical-map-data.js?v=20260622-hp-polish-r1';
import { getUnitEntryPhaseIndex } from './phase-engine.js?v=20260622-hp-polish-r1';
import {
...
} from './position-engine.js?v=20260622-hp-polish-r1';
import { resolveCampaignPhase } from './campaign-state-machine.js?v=20260622-hp-polish-r1';
